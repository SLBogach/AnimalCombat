...
internal static class BalanceV01Schema
{
    ...
    public const string MaximumEventsPerBattleSetting = "global.sim.max_events_per_battle";
    public const string MaximumZeroProgressTicksSetting = "global.sim.max_zero_progress_ticks";
