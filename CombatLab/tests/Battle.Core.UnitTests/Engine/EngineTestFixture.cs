...
internal static class EngineTestFixture
{
        ...
        Sha256Digest? configHash = null)
    {
        var settings = Properties(
            ...
            ("global.damage.armor_k", ConfigValue.FromInteger(200)),
            ("global.damage.block_max", ConfigValue.FromInteger(900)),
            ("global.damage.block_min", ConfigValue.FromInteger(100)),
            ("global.damage.block_slope", ConfigValue.FromInteger(3)),
            ("global.damage.cap", ConfigValue.FromInteger(600)),
            ("global.damage.dodge_max", ConfigValue.FromInteger(850)),
            ("global.damage.dodge_min", ConfigValue.FromInteger(50)),
            ("global.damage.dodge_slope", ConfigValue.FromInteger(3)),
            ("global.damage.floor", ConfigValue.FromInteger(1)),
            ("global.control.control_k", ConfigValue.FromInteger(150)),
            ("global.control.force_k", ConfigValue.FromInteger(120)),
            ("global.control.grab_lockout_ticks", ConfigValue.FromInteger(20)),
            ("global.control.max_hold_ticks", ConfigValue.FromInteger(12)),
            ("global.control.stun_max_ticks", ConfigValue.FromInteger(20)),
            ("global.control.stun_min_ticks", ConfigValue.FromInteger(3)),
        ...
        var fighters = new[]
        {
            Entity(
                ...
                ("armor", ConfigValue.FromInteger(135)),
                ("control_power", ConfigValue.FromInteger(95)),
                ("control_resistance", ConfigValue.FromInteger(135)),
                ("evasion", ConfigValue.FromInteger(55)),
                ("guard", ConfigValue.FromInteger(145)),
                ("guard_break", ConfigValue.FromInteger(115)),
                ...
                ("mass", ConfigValue.FromInteger(150)),
                ("power", ConfigValue.FromInteger(145)),
                ("precision", ConfigValue.FromInteger(80)),
            ...
            Entity(
                ...
                ("armor", ConfigValue.FromInteger(70)),
                ("control_power", ConfigValue.FromInteger(100)),
                ("control_resistance", ConfigValue.FromInteger(85)),
                ("evasion", ConfigValue.FromInteger(145)),
                ("guard", ConfigValue.FromInteger(75)),
                ("guard_break", ConfigValue.FromInteger(90)),
                ...
                ("mass", ConfigValue.FromInteger(85)),
                ("power", ConfigValue.FromInteger(105)),
                ("precision", ConfigValue.FromInteger(140)),
    ...
    private static CompiledConfigEntity CombatAction(
        ...
        ("action_priority", ConfigValue.FromInteger(10)),
        ("animal_id", ConfigValue.FromString(animalId)),
        ("base_damage", ConfigValue.FromInteger(10)),
        ...
        ("blockable", ConfigValue.FromBoolean(true)),
        ("category", ConfigValue.FromString("SignatureStrike")),
        ("chip_min", ConfigValue.FromInteger(1)),
        ("clash_priority", ConfigValue.FromInteger(10)),
        ("cooldown_ticks", ConfigValue.FromInteger(10)),
        ("dodge_base_chance_fp", ConfigValue.FromInteger(0)),
        ("dodgeable", ConfigValue.FromBoolean(true)),
        ...
        ("interrupt_profile", ConfigValue.FromString("Cancelable")),
        ...
        ("min_damage", ConfigValue.FromInteger(1)),
        ...
        ("resolution_priority", ConfigValue.FromInteger(10)),
        ...
        ("tags", ConfigValue.FromString("signature|special|strike")),
    ...
    private static CompiledConfigEntity SystemAction(
        ...
        ("action_priority", ConfigValue.FromInteger(1)),
        ...
        ("resolution_priority", ConfigValue.FromInteger(1)),
