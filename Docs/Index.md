...
7. [Combat Test Plan WP-08 v0.1](./Combat_Test_Plan_WP-08_v0.1.md) — реализованная blocking exact pass/fail-матрица Decisions: `107` unique IDs; local gates green, CI matrix pending.
...
| WP-08 | Decisions | `LOCAL IMPLEMENTATION COMPLETE / CI PENDING` | [WP-08 Brief](./WP-08_Brief.md) |
...
- [Реализованный локально WP-08 Decisions — CI pending](./WP-08_Brief.md)
- [Combat Test Plan WP-08 v0.1 — IMPLEMENTED / LOCAL VERIFIED; CI PENDING](./Combat_Test_Plan_WP-08_v0.1.md)
