...
6. [Combat Test Plan WP-07 v0.1](./Combat_Test_Plan_WP-07_v0.1.md) — exact pass/fail-матрица Movement; закрывает `OPEN-WP07-01..13`.
...
| WP-07 | Movement | готов к реализации; код не начат | [WP-07 Brief](./WP-07_Brief.md) |
...
- [Подготовленный WP-07 Movement](./WP-07_Brief.md)
